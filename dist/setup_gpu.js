...
export async function setupGPU(canvas) {
...
export async function initWebGPU(canvas, shader, fractal, device) {
    ...
    const paramBuffer = fractal.asBuffer();
...
//# sourceMappingURL=setup_gpu.js.map